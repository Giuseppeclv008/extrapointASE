...
{
	if(timer == 0) LPC_TIM0->TCR = 1;
	else if(timer == 1) LPC_TIM1->TCR = 1;
	else if(timer == 2) LPC_TIM2->TCR = 1;
...
{
	if(timer == 0) LPC_TIM0->TCR = 0;
	else if(timer == 1) LPC_TIM1->TCR = 0;
	else if(timer == 2) LPC_TIM2->TCR = 0;
...
uint32_t init_timer (uint8_t timer_num, uint32_t TimerInterval)
{
	if(timer_num == 0){
		...
		LPC_TIM0->MR0 = TimerInterval; // 1 secondo;
